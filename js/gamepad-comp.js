import {html, render} from 'https://unpkg.com/lit-html@0.9.0/lib/lit-extended.js';

//game-pad web component class
customElements.define('game-pad', class extends HTMLElement {
    render() {
        return html`
            <style>
                :host {
